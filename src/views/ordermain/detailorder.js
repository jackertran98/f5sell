...
class OrderMain extends Component {
    ...
    render() {
        const { selectedValue, Data, loading, List, message, setSelectedValue,modalVisible } = this.state;
        console.log("this is data", List);
        console.log("data full ", this.props.authUser.GROUPS);
            ...
            <View>
                ...
                {!loading ? null : <View style={{ marginBottom: 20 }}>
                    <ScrollView>
                            ...
                            <View style={{ flexDirection: 'row' }}>
                                ...
                                <View>
                                    ...
                                    <View style={{ flexDirection: 'row', width: sizeWidth(100), padding: 10, paddingTop: 0, justifyContent: "space-between" }}>
                                        ...
                                        <Text>{numeral(sumAllMoney()).format("0,0")} đ</Text>
                                    </View>
                                </View>
                        ...
                        {this.props.authUser.GROUPS == 8 ? null :
                            <View>
                                ...
                                <View>
                                    ...
                                    <View style={{ flexDirection: 'row', paddingLeft: 10, marginTop: 7, justifyContent: 'space-between', paddingRight: 10 }}>
                                        <Text>Số tiền cần phải trả</Text>
                                        <Text></Text>
                                    </View>
                                    <View style={{ flexDirection: 'row', paddingLeft: 10, marginTop: 7, justifyContent: 'space-between', paddingRight: 10 }}>
                            ...
                            <View style={{ justifyContent: 'center', flexDirection: 'row', marginTop: 10 }}>
                                <TouchableOpacity
                                    ...
                                    style={{
                                        ...
                                        , backgroundColor: '#E1AC06', alignItems: 'center', borderRadius: 5
                                    }}
                                >
