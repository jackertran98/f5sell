        ...
        return (
            <View >
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', margin: 10 }}>
                    <View>
                        <TextInput
                            ...
                            style={{ width: sizeWidth(30), height: sizeHeight(5), borderColor: 'gray', borderWidth: 1, paddingLeft: 10 }}
                        />
                ...
                <View style={{ margin: 10 }}>
                    <Text style={{ color: 'red', fontStyle: 'italic', paddingTop: 10, paddingBottom: 10, fontSize: 13 }}>Lưu ý: số tiền nhập không lớn hơn số dư hoa hồng hiện tại tổng số hoa hồng chờ duyệt</Text>
                </View>
                <View style={{ width: sizeWidth(100), height: sizeHeight(5), backgroundColor: 'gray', justifyContent: 'center', paddingLeft: 10 }}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', margin: 10, justifyContent: 'space-between' }}>
                            <View style={{flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
                                ...
                                >
                                    <DropDownPicker
                                        ...
                                        style={{ backgroundColor: '#fafafa', width: sizeWidth(38), borderColor: '#E1AC06', borderWidth: 1 }}
                                        itemStyle={{
                            ...
                            <View>
                                <TouchableOpacity
                                    ...
                                    style={{width:sizeWidth(30),height:sizeHeight(5),backgroundColor:'#149CC6',justifyContent:'center',alignItems:'center'}}
                                >
