        ...
        return (
            <ScrollView nestedScrollEnabled={true}>
                <View style={{ height: sizeHeight(13),justifyContent:'center',alignItems:'center' }}>
                    <View style={{height: sizeHeight(4.5),width:sizeWidth(98), borderRadius: 20, backgroundColor: 'black', fontSize: 16,justifyContent:'center',alignItems:'center',marginTop:10}}>
                ...
                <View>
                    ...
                    <TouchableOpacity
                        ...
                        style={{justifyContent:'center',alignItems:'center',marginTop:10,width:sizeWidth(80),height:sizeHeight(5),backgroundColor:'#E1AC06'}}
