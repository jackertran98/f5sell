...
class DrawerContent extends Component {
    ...
    render() {
        ...
        return (
            <View style={{ flex:1 }}>
                {status != '' ? <View><TouchableOpacity style={{ flexDirection: 'row', backgroundColor: "#E1AC06", height: 100, justifyContent: 'space-between', alignItems: "center", paddingLeft: 10, paddingTop: sizeHeight(3) }}
                ...
                <Drawer.Section>
                    ...
                    <DrawerItem
                        ...
                        label={({ focused, color }) => <Text style={{ color: '#E1AC06', fontSize: 16 }}>{`Giới thiệu ${this.props.idshop.SHOP_NAME}`}</Text>}
                        style={{height:sizeHeight(5.5),backgroundColor:'#fff',justifyContent:'center'}}
