...
MyAccountStack = (props) => {
  ...
  const { status, navigation, route, authUser } = props;
        ...
        options={{
          ...
          headerTitle: () => {
            if (status === "") {
              ...
              return authUser.GROUPS === "3" ? null : status != "" ? (
                <View>
                  <Text style={{ color: "#fff", textAlign: "center" }}>
                    {authUser.FULL_NAME}{" "}
                  </Text>
                  <Text style={{ color: "#fff", textAlign: "center" }}>
                    Điểm tích luỹ: {authUser.COMISSION}đ{" "}
                  </Text>
                </View>
              ) : null;
            }
            ...
            status != "" ? (
              <HeaderRightComponet
                ...
                onPress={() => {
                  ...
                  } else navigation.navigate("UpdateAccount");
                }}
                name="cog"
                size={sizeFont(6)}
                color="#fff"
          ...
          //   },
          //   elevation: 0,
          //   backgroundColor: status != "" ? COLOR.HEADER : null,
          //},
        }}
      />
      <AccountStack.Screen
